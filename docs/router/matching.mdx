...
<Tabs>
  <Tab title="Python">
    ...
    matches = router.fetch_matches(market_id="d35bc8c6-...", min_confidence=0.8)
  ...
  <Tab title="TypeScript">
    ...
    const matches = await router.fetchMatches({
      marketId: "d35bc8c6-...",
      minConfidence: 0.8,
    });
...
matches = router.fetch_matches(market_id="...", relation="identity")

# Only subset/superset (useful for hedging — see fetchHedges)
matches = router.fetch_matches(market_id="...", relation="subset")
```
